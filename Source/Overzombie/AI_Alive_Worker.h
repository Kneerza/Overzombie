...
#include "AI_Alive_Worker.generated.h"
...
class APawn_Alive_Worker;

/**
 * 
 */
UCLASS()
class OVERZOMBIE_API AAI_Alive_Worker : public AAI_Overzombie_Alive
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, Category = Tracking)
		APawn_Alive_Worker* PossessedAliveWorker_Ref;
...
private:
	...
	APawn_Zombie* GetClosestZombie_Vision();
